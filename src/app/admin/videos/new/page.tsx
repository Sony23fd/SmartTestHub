            ...
            <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "16px", padding: "20px", display: "flex", flexDirection: "column", gap: "18px" }}>
              ...
              <div>
                ...
                <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
                  ...
                  {thumbnailUrl && <span style={{ color: "#86efac", fontSize: "0.8rem" }}>✓ Зураг хуулагдсан</span>}
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
                  ...
                  />
                  {uploadingVideo && (
                    <div style={{ display: "flex", alignItems: "center", gap: "6px", color: "#7c9eff", fontSize: "0.8rem" }}>
                      <Loader2 size={16} style={{ animation: "spin 1s linear infinite" }} />
                      <span>Видео файлыг сервер рүү хуулж байна...</span>
                    </div>
                  )}
